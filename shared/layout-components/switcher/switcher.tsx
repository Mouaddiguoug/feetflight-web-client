...
const Switcher = ({ local_varaiable, ThemeChanger }: any) => {
  ...
  useEffect(() => {
    ...
    html.setAttribute('class', local_varaiable.class || '');
    html.setAttribute('data-header-styles', local_varaiable.dataHeaderStyles);
    html.setAttribute('data-vertical-style', local_varaiable.dataVerticalStyle);
    html.setAttribute('data-nav-layout', local_varaiable.dataNavLayout);
    html.setAttribute('data-menu-styles', local_varaiable.dataMenuStyles);
    html.setAttribute('data-toggled', local_varaiable.dataToggled);
    html.setAttribute('data-nav-style', local_varaiable.dataNavStyle);
    html.setAttribute('hor-style', local_varaiable.horStyle);
    html.setAttribute('data-page-style', local_varaiable.dataPageStyle);
    html.setAttribute('data-width', local_varaiable.dataWidth);
    html.setAttribute('data-menu-position', local_varaiable.dataMenuPosition);
    html.setAttribute('data-header-position', local_varaiable.dataHeaderPosition);
    html.setAttribute('icon-overlay', local_varaiable.iconOverlay);
    html.setAttribute('bg-img', local_varaiable.bgImg);
    html.setAttribute('icon-text', local_varaiable.iconText);
